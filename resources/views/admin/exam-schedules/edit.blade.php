    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <h4 class="mb-sm-0">Edit Exam Schedule</h4>
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">
                        Update examination, course, class, section, date, time and room.
                    </p>
                                ...
                                <select name="examination_id"
                                    ...
                                    @foreach($examinations as $examination)
                                        ...
                                        <option value="{{ $examination->id }}"
                                            ...
                                            {{ old(
                                                'examination_id',
                                                $examSchedule->examination_id
                                            ) == $examination->id ? 'selected' : '' }}>
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 mt-1">
                                        ...
                                        dates are defined. Exam times cannot overlap
                                        with another schedule for the same examination,
