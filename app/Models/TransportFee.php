...
class TransportFee extends Model
{
    ...
    protected $fillable = ['school_id','route_student_id','fee_month','amount','status','invoice_id','notes'];
    protected $casts = ['id'=>'integer','school_id'=>'integer','route_student_id'=>'integer','fee_month'=>'date','amount'=>'decimal:2','invoice_id'=>'integer','created_at'=>'datetime','updated_at'=>'datetime','deleted_at'=>'datetime'];
