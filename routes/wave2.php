    ...
    */
    ...
    Route::prefix('transport')
        ...
        */
        ...
        Route::get(
            '/drivers',
            [TransportMasterController::class, 'drivers']
        )
        ...
        Route::post(
            '/drivers',
            [TransportMasterController::class, 'storeDriver']
        )
            ->middleware('permission:transport.manage')
            ->name('drivers.store');
        ...
        */
        ...
        Route::get(
            '/vehicles',
            [TransportMasterController::class, 'vehicles']
        )
            ->middleware('permission:transport.manage')
            ->name('vehicles.index');
        ...
        Route::post(
            '/vehicles',
            [TransportMasterController::class, 'storeVehicle']
        )
            ->middleware('permission:transport.manage')
            ->name('vehicles.store');
        ...
        */
        ...
        Route::get(
            '/routes/create',
            [TransportController::class, 'createRoute']
        )
            ->middleware('permission:transport.manage')
            ->name('routes.create');
        ...
        Route::post(
            '/routes',
            [TransportController::class, 'storeRoute']
        )
            ->middleware('permission:transport.manage')
            ->name('routes.store');
        ...
        |--------------------------------------------------------------------------
        |
        | Must be before any /routes/{route} wildcard route.
        |
        */

        Route::get(
            '/routes/{route}/stops',
            [TransportMasterController::class, 'stops']
        )
            ->middleware('permission:transport.manage')
        ...
        Route::post(
            '/routes/{route}/stops',
            [TransportMasterController::class, 'storeStop']
        )
            ->middleware('permission:transport.manage')
        ...
        */
        ...
        Route::get(
            '/assignments',
            [TransportController::class, 'assignments']
        )
        ...
        Route::get(
            '/assignments/create',
            [TransportController::class, 'createAssignment']
        )
            ->middleware('permission:transport.assign')
        ...
        Route::post(
            '/assignments',
            [TransportController::class, 'storeAssignment']
        )
            ->middleware('permission:transport.assign')
        ...
        Route::delete(
            ...
            [TransportController::class, 'destroyAssignment']
        )
            ->middleware('permission:transport.assign')
